...
const profileCols = (prefix = '') => `
  ...
  ${prefix}bio_color, ${prefix}bio_font_size, ${prefix}bio_font_weight,
  ...
  ${prefix}cover_edge_h, ${prefix}cover_edge_v, ${prefix}cover_container_width,
  ${prefix}cover_aspect_w, ${prefix}cover_aspect_h,
  ${prefix}bg_rotation,    ${prefix}bg_fill_color,    ${prefix}bg_blur,   ${prefix}bg_edge,
  ${prefix}bg_edge_h, ${prefix}bg_edge_v,
  ...
  ${prefix}content_wrapper_text_color, ${prefix}content_wrapper_accent_color, ${prefix}content_wrapper_font_weight,
  ...
  ${prefix}post_card_text_color, ${prefix}post_card_accent_color, ${prefix}post_card_font_weight,
...
function formatUser(row) {
  return {
    ...
    coverEdgeH:             row.cover_edge_h           ?? 0,
    coverEdgeV:             row.cover_edge_v           ?? 0,
    coverContainerWidth:    row.cover_container_width  ?? 100,
    coverAspectW:           row.cover_aspect_w         ?? 4,
    coverAspectH:           row.cover_aspect_h         ?? 1,
    ...
    bgEdgeH:        row.bg_edge_h        ?? 0,
    bgEdgeV:        row.bg_edge_v        ?? 0,
    ...
    contentWrapperFontWeight:      row.content_wrapper_font_weight      ?? 400,
    ...
    postCardFontWeight:   row.post_card_font_weight   ?? 400,
  };
}
...
router.put('/:id/profile', requireAuth, async (req, res) => {
  ...
  const {
    ...
    contentWrapperTextColor, contentWrapperAccentColor, contentWrapperFontWeight,
    ...
    postCardTextColor, postCardAccentColor, postCardFontWeight,
  } = req.body;
  ...
  try {
    ...
    const n = {
      ...
      bioColor:       bioColor       !== undefined ? (bioColor || null)             : (cur.bio_color      || null),
      bioFontSize:    bioFontSize    !== undefined ? clamp(bioFontSize,   10, 32)   : (cur.bio_font_size  ?? 14),
      bioFontWeight:  bioFontWeight  !== undefined ? clamp(bioFontWeight, 100, 900) : (cur.bio_font_weight ?? 400),
      ...
      coverEdgeH:            coverEdgeH            !== undefined ? clamp(coverEdgeH,            0, 100) : (cur.cover_edge_h          ?? 0),
      coverEdgeV:            coverEdgeV            !== undefined ? clamp(coverEdgeV,            0, 100) : (cur.cover_edge_v          ?? 0),
      coverContainerWidth:   coverContainerWidth   !== undefined ? clamp(coverContainerWidth,  40, 100) : (cur.cover_container_width ?? 100),
      coverAspectW:          coverAspectW          !== undefined ? clamp(coverAspectW,           1,  32) : (cur.cover_aspect_w       ?? 4),
      coverAspectH:          coverAspectH          !== undefined ? clamp(coverAspectH,           1,  32) : (cur.cover_aspect_h       ?? 1),
      ...
      bgEdgeH:  bgEdgeH  !== undefined ? clamp(bgEdgeH,  0, 100) : (cur.bg_edge_h ?? 0),
      bgEdgeV:  bgEdgeV  !== undefined ? clamp(bgEdgeV,  0, 100) : (cur.bg_edge_v ?? 0),
      ...
      contentWrapperFontWeight:   contentWrapperFontWeight   !== undefined ? clamp(contentWrapperFontWeight, 100, 900) : (cur.content_wrapper_font_weight ?? 400),
      ...
      postCardFontWeight:   postCardFontWeight   !== undefined ? clamp(postCardFontWeight, 100, 900) : (cur.post_card_font_weight ?? 400),
    };
      ...
      db.run(
        `UPDATE users
         SET cover_url = ?,      background_url = ?,    bio = ?,            updated_at = ?,
             bio_color = ?,      bio_font_size = ?,     bio_font_weight = ?,
             cover_pos_x = ?,    cover_pos_y = ?,       cover_scale = ?,
             bg_pos_x = ?,       bg_pos_y = ?,          bg_scale = ?,
             cover_rotation = ?, cover_fill_color = ?,  cover_blur = ?,     cover_edge = ?,
             cover_edge_h = ?,   cover_edge_v = ?,      cover_container_width = ?,
             cover_aspect_w = ?, cover_aspect_h = ?,
             ...
             content_wrapper_text_color = ?, content_wrapper_accent_color = ?, content_wrapper_font_weight = ?,
             ...
             post_card_text_color = ?, post_card_accent_color = ?, post_card_font_weight = ?
         WHERE id = ?`,
        [
          n.coverUrl, n.bgUrl, n.bio, updatedAt,
          n.bioColor, n.bioFontSize, n.bioFontWeight,
          n.coverPosX, n.coverPosY, n.coverScale,
          n.bgPosX, n.bgPosY, n.bgScale,
          n.coverRotation, n.coverFillColor, n.coverBlur, n.coverEdge,
          n.coverEdgeH, n.coverEdgeV, n.coverContainerWidth,
          n.coverAspectW, n.coverAspectH,
          ...
          n.contentWrapperTextColor, n.contentWrapperAccentColor, n.contentWrapperFontWeight,
          ...
          n.postCardTextColor, n.postCardAccentColor, n.postCardFontWeight,
          id,
        ],
